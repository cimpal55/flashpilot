"""Deterministic Markdown and HTML for distributed FSDP qualification."""
...
def render_distributed_markdown(result: DistributedQualificationResult) -> str:
    checks = "\n".join(
    ...
    return (
        "# Distributed PyTorch FSDP qualification\n\n"
...
def render_distributed_html(result: DistributedQualificationResult) -> str:
    checks = "".join(
    ...
    return (
        ...
        "<title>FlashPilot distributed FSDP qualification</title></head><body>"
        "<h1>Distributed PyTorch FSDP qualification</h1>"
