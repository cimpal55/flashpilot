"""Deterministic human-readable Lightning qualification reports."""
...
def render_lightning_markdown(result: LightningQualificationResult) -> str:
    checks = "\n".join(
...
def render_lightning_html(result: LightningQualificationResult) -> str:
    checks = "".join(
    ...
    return (
        ...
        "<title>FlashPilot Lightning qualification</title></head><body>"
        "<h1>PyTorch Lightning qualification</h1>"
